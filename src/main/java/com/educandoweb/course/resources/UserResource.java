...
public class UserResource {
	...
	@DeleteMapping(value = "/{id}") // PathVariable to id be recognize as a variable of the URL
	public ResponseEntity<Void> delete(@PathVariable Long id){ // void because we don't need a body return
		service.delete(id);
